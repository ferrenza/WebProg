...
from django.utils.html import escape, mark_safe, escape
...
class AttendingCourse(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['attending_course_id', 'attending_courseid']),
        ]

class User(models.Model):
    id = models.AutoField(primary_key=True)  # Ubah menjadi AutoField
